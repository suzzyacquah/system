 ...
 <div class="content-body">
            <div class="container-fluid">
               <div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Apartments</a></li>
                                ...
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Creed Apartment</a></h4>
                                            ...
                                            <p>Availability: <span class="item"> <button>rooms</button> <i class="fa fa-check-circle text-success"></i></span></p>
                                            <p>Apartment Location: <span class="item">East Lagon</span> </p>
                                            <p>Digital Address: <span class="item">GC-24436-A</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Blue Top Apartment</a></h4>
											<div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                                            ...
                                            <p>Location: <span class="item">Greater Accra</span></p>
                                            <p>Digital Address: <span class="item">GC-24436-A</span></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Highspeed Apartment</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                                            ...
                                            <p>Availability: <span class="item"> In stock <i class="fa fa-check-circle text-success"></i></span></p>
                                            <p>Product code: <span class="item">0405689</span> </p>
                                            <p>Location: <span class="item">East Lagon</span></p>
                                            <p>Digital Address: <span class="item">GC-24436-A</span></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            ...
                                            <p>Availability: <span class="item"> In stock <i class="fa fa-check-circle text-success"></i></span></p>
                                            <p>Product code: <span class="item">0405689</span> </p>
                                            <p>Location: <span class="item">Eastern Region</span></p>
                                            <p>Digital Address: <span class="item">GC-24436-A</span></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Beep Apartment</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-b-30">
                                    ...
                                    <div class="col-md-7 col-xxl-12">
                                        <div class="new-arrival-content position-relative">
                                            <h4><a href="ecom-product-detail.html">Redblue Apartment</a></h4>
                                            <div class="comment-review star-rating">
                                                <ul>
                                                    <li><i class="fa fa-star"></i></li>
                                                    <li><i class="fa fa-star"></i></li>
                                            ...
                                            <p>Availability: <span class="item"> In stock <i class="fa fa-check-circle text-success"></i></span></p>
                                            <p>Product code: <span class="item">0405689</span> </p>
                                            <p>Location: <span class="item">Central Region</span></p>
                                            <p>Digital Address: <span class="item">GC-24436-A</span></p>
                                        </div>
                                    </div>
                                </div>
