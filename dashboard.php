...
$sql = "SELECT COUNT(*) as totals FROM `tbl_tenants` WHERE 1";
$result=mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);


$sql2 = "SELECT sum(`amount`) as totals2 FROM `tbl_payments` WHERE 1";
$result2=mysqli_query($conn,$sql2);
$row2 = mysqli_fetch_assoc($result2);



$sql3 = "SELECT COUNT(*) as totals3 FROM `tbl_rooms` WHERE 1";
                ...
                <div class="card-body p-4">
                    <div class="media">
                        ...
                        <div class="media-body text-white text-end">
                            ...
                            <h3 class="text-white"><?php echo $row3['totals3'] ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-footer p-4">
                <button type="button" class="btn btn-light"><a href="room.php">View List</a></button>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    <div class="media">
                        ...
                        <div class="media-body text-white text-end">
                            ...
                            <h3 class="text-white"><?php echo $row['totals'] ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-footer p-4">
       ...
       <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                ...
                <div class="card-body p-4">
                    <div class="media">
                        ...
                        <div class="media-body text-white text-end">
                            ...
                            <h3 class="text-white">GHC <?php echo number_format($row2['totals2'],2) ?></h3>
                        </div>
                    </div>
                </div>
                <div class="card-footer p-4">
                <button type="button" class="btn btn-light"><a href="Payments2.php">View List</a></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
            <div class="widget-stat card bg-primary">
                ...
                <div class="card-footer p-4" >
                <button type="button" class="btn btn-light"><a href="Report1.php">View List</a></button>
                </div>
            </div>
        </div>
    </div>
