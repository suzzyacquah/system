...
<!-- DataTables CSS -->
<link rel="stylesheet" type="text/css" href="https:../jquery.dataTables.css">
<!-- DataTables Buttons CSS -->
<link rel="stylesheet" type="text/css" href="https:../buttons.dataTables.min.css">
<!-- DataTables CSS -->
<link rel="stylesheet" type="text/css" href="https:../jquery.dataTables.css">
<!-- DataTables Buttons CSS -->
<link rel="stylesheet" type="text/css" href="https:../buttons.dataTables.min.css">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
            <a href="http://localhost/myapp/dashboard.php" class="brand-logo">
				<svg class="logo-abbr" width="55" height="55" viewbox="0 0 55 55" fill="none" xmlns="">
					<a class="nav-link" href="http://localhost/myapp/dashboard.php" role="button" data-bs-toggle="dropdown">
									<img src="images/sa rent.png" width="56" alt="">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									...
									<i class="fas fa-user" width="56"></i>

								</a>
								<span><?php echo $_SESSION['DATA']['first_name'] ?>
									<?php echo $_SESSION['DATA']['last_name'] ?> </span>
								<div class="dropdown-menu dropdown-menu-end">
